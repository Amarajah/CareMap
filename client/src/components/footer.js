      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/infohub" className="text-gray-400 hover:text-white transition-colors">InfoHub</Link></li>
              <li><Link to="/clinicmap" className="text-gray-400 hover:text-white transition-colors">ClinicMap</Link></li>
            </ul>
          </div>
        ...
        <div className="border-t border-gray-700 mt-8 pt-8 text-center">
          <p className="text-gray-400">
            © 2024 CareMap. All rights reserved. | Built with ❤️ for better healthcare access.
          </p>
        </div>
      </div>
    </footer>
