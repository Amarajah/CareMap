...
const Infohub = () => {
  ...
  const toggleBookmark = async (article) => {
    try {
      ...
      if (isBookmarked) {
        // Remove bookmark
        const deleteUrl = `http://localhost:8000/api/bookmarks/${encodeURIComponent(article.id)}`;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 mb-2">
              Curated Health Articles For <span class="underline font-bold">YOU</span> From Trusted Sources
            </p>
