...
export default function AboutCareMap() {
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {companyData.targetUsers.map((user, index) => (
              <div key={index} className="bg-white bg-opacity-20 backdrop-blur-sm rounded-lg p-6 text-center hover:bg-opacity-30 transition-all duration-300">
                <div className="text-3xl mb-3">👥</div>
                <p className="text-lg text-gray-800">{user}</p>
              </div>
            ))}
          </div>
        </div>
